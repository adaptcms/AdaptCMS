...
class UsersEngineController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('users::UsersEngine/index', [
            'items' => $items,
            'roles' => $roles
        ]);
    }
    ...
    public function add(Request $request)
    {
        ...
        return view('users::UsersEngine/add', [ 'model' => $model, 'roles' => $model->getRolesList() ]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('users::UsersEngine/edit', [ 'model' => $model, 'roles' => $model->getRolesList() ]);
    }
